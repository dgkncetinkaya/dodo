    ...
    $(document).ready(function() {
        ...
        $('#dodo-blog-form').on('submit', function(e) {
            ...
            const formData = {
                ...
                // Advanced Controls - BOŞ GÖNDER (Brain override için)
                publish_mode: $('#publish_mode').val() || 'draft',
                scheduled_date: $('#scheduled_date').val() || '',
                scheduled_time: $('#scheduled_time').val() || '',
                // Kullanıcı seçmediyse boş string gönder (default değil)
                content_intent: $('#content_intent').val() || '',
                expertise_depth: $('#expertise_depth').val() || '',
                geo_optimization: $('#geo_optimization').val() || '',
                ai_naturalness: $('#ai_naturalness').val() || '',
                semantic_aggressiveness: $('#semantic_aggressiveness').val() || '',
                readability_target: $('#readability_target').val() || '',
